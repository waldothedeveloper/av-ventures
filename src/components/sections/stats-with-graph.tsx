...
export function Stat({
  ...
  return (
    <div
      className={clsx(
        "border-l border-olive-950/20 pl-6 dark:border-white/20",
        className,
      )}
      {...props}
    >
      <div className="text-2xl/10 tracking-tight text-olive-950 dark:text-white">
        {stat}
      </div>
  ...
  return (
    <Section {...props}>
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
        <div className="grid grid-cols-1 gap-x-2 gap-y-10 sm:col-span-2 lg:col-span-4 sm:grid-cols-2 lg:grid-cols-4">
          {children}
        </div>
      </div>
